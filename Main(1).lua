...
function MacUI:Window(config)
    ...
    local TitleBarLeftTopRightCornerMask = create("Frame", {
        Parent = TitleBarLeft,
    ...
    local TitleBarRightTopCornerMask = create("Frame", {
        Parent = TitleBarRight,
        Size = UDim2.new(0, 14, 0, 14),
        Position = UDim2.new(1, -14, 0, 0),
        BackgroundColor3 = currentTheme.Background,
    ...
    create("UICorner", { Parent = SidebarBG, CornerRadius = UDim.new(0, 14) })
    ...
    local SidebarBottomRightCornerMask = create("Frame", {
        Parent = Sidebar,
        Size = UDim2.new(0, 14, 0, 14),
        Position = UDim2.new(1, -14, 1, -14),
