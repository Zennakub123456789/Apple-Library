...
function MacUI:Window(config)
    ...
    function self:SelectTab(index)
        ...
        for i, tab in ipairs(self.Tabs) do
            ...
            if tab.Button and typeof(tab.Button) == "Instance" then
                ...
                if not tab.Label then
                    tween(tab.Button, 0.18, { TextColor3 = currentTheme.TextInactive })
                end
            end
        ...
        if selectedTab.Button and typeof(selectedTab.Button) == "Instance" then
            selectedTab.Button.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
            tween(selectedTab.Button, 0.18, { BackgroundTransparency = 0 })
            
            if not selectedTab.Label then
                tween(selectedTab.Button, 0.18, { TextColor3 = Color3.fromRGB(255, 255, 255) })
            end
        end
    ...
    function self:Tab(name, icon)
        ...
        Button.MouseEnter:Connect(function()
            if self.SelectedTab ~= tabIndex then
                ...
                tween(Button, 0.15, { BackgroundTransparency = 0.5 })
            end
        end)
