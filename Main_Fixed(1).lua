...
function MacUI:Window(config)
    ...
    create("UICorner", { Parent = TopLeftCorner, CornerRadius = UDim.new(0, cornerRadius) })
    ...
    create("UICorner", { Parent = TopRightCorner, CornerRadius = UDim.new(0, cornerRadius) })
    
    -- มุมซ้ายล่าง
    local BottomLeftCorner = create("Frame", {
        Parent = MainFrame,
        Size = UDim2.new(0, cornerSize, 0, cornerSize),
    ...
    create("UICorner", { Parent = BottomLeftCorner, CornerRadius = UDim.new(0, cornerRadius) })
    
    -- มุมขวาล่าง
    local BottomRightCorner = create("Frame", {
        Parent = MainFrame,
        Size = UDim2.new(0, cornerSize, 0, cornerSize),
    ...
    create("UICorner", { Parent = BottomRightCorner, CornerRadius = UDim.new(0, cornerRadius) })
