...
function MacUI:Window(config)
    ...
    function self:SelectTab(index)
        ...
        if selectedTab.Button and typeof(selectedTab.Button) == "Instance" then
            ...
            task.defer(function()
                if selectedTab.Button and selectedTab.Button.Parent then
                    selectedTab.Button.BackgroundTransparency = 0
                    selectedTab.Button.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
                end
            end)
        ...
        if selectedTab.Label and typeof(selectedTab.Label) == "Instance" then
            selectedTab.Label.TextColor3 = Color3.fromRGB(255, 255, 255)
        end
        
        if selectedTab.Icon and typeof(selectedTab.Icon) == "Instance" then
            selectedTab.Icon.ImageColor3 = Color3.fromRGB(255, 255, 255)
        end
    ...
    function self:Tab(name, icon)
        ...
        Button.MouseButton1Click:Connect(function()
            ...
            if tab.HoverTween then
                tab.HoverTween:Cancel()
                tab.HoverTween = nil
            end
        ...
        Button.MouseEnter:Connect(function()
            ...
            tab.HoverTween = tween(Button, 0.15, { BackgroundTransparency = 0.5 })
        end)
        
        Button.MouseLeave:Connect(function()
            if self.CurrentTab == tabIndex then return end
            if self.SelectedTab == tabIndex then return end
            if tab.HoverTween then
                tab.HoverTween:Cancel()
            end
            tab.HoverTween = tween(Button, 0.15, { BackgroundTransparency = 1 })
        end)
