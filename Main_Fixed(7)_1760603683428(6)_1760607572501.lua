...
function MacUI:Window(config)
    ...
    function self:SelectTab(index)
        ...
        for i, tab in ipairs(self.Tabs) do
            ...
            if i ~= index and tab.Button and typeof(tab.Button) == "Instance" then
        ...
        print("[MacUI Debug] selectedTab.Button:", selectedTab.Button)
        print("[MacUI Debug] typeof selectedTab.Button:", typeof(selectedTab.Button))
        ...
        if selectedTab.Button and typeof(selectedTab.Button) == "Instance" then
            print("[MacUI Debug] Inside Button check - SUCCESS!")
            ...
            selectedTab.Button.BackgroundTransparency = 0
            selectedTab.Button.BackgroundColor3 = currentTheme.TabActive
            
            print("[MacUI Debug] After setting - Transparency:", selectedTab.Button.BackgroundTransparency)
            print("[MacUI Debug] After setting - Color:", selectedTab.Button.BackgroundColor3)
            
            task.spawn(function()
                task.wait(0.01)
                print("[MacUI Debug] Check 1 (0.01s) - Transparency:", selectedTab.Button.BackgroundTransparency)
                print("[MacUI Debug] Check 1 (0.01s) - Color:", selectedTab.Button.BackgroundColor3)
                selectedTab.Button.BackgroundTransparency = 0
                selectedTab.Button.BackgroundColor3 = currentTheme.TabActive
                
                task.wait(0.02)
                print("[MacUI Debug] Check 2 (0.03s) - Transparency:", selectedTab.Button.BackgroundTransparency)
                print("[MacUI Debug] Check 2 (0.03s) - Color:", selectedTab.Button.BackgroundColor3)
                selectedTab.Button.BackgroundTransparency = 0
                selectedTab.Button.BackgroundColor3 = currentTheme.TabActive
            end)
            ...
            print("[MacUI Debug] PROBLEM: Button check FAILED!")
            print("[MacUI Debug] selectedTab.Button is:", selectedTab.Button)
            print("[MacUI Debug] Reason: Button is nil or not an Instance")
        end
