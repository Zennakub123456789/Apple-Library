...
function MacUI:Window(config)
    ...
    local Themes = {
        ...
        Dark = {
            Background = Color3.fromRGB(41, 42, 45),
            Sidebar = Color3.fromRGB(36, 36, 38),
            TitleBar = Color3.fromRGB(44, 45, 49),
            TitleBarLeft = Color3.fromRGB(36, 36, 38),
            TitleBarRight = Color3.fromRGB(44, 45, 49),
            TitleBarDivider = Color3.fromRGB(50, 51, 55),
            Content = Color3.fromRGB(41, 42, 45),
            Accent = Color3.fromRGB(10, 132, 255),
            TabInactive = Color3.fromRGB(36, 36, 38),
    ...
    function self:SelectTab(index)
        ...
        for i, tab in ipairs(self.Tabs) do
            ...
            if tab.Button and typeof(tab.Button) == "Instance" then
                tween(tab.Button, 0.18, { BackgroundColor3 = Color3.fromRGB(0, 0, 0), BackgroundTransparency = 1 })
            ...
            if tab.Label and typeof(tab.Label) == "Instance" then
                tween(tab.Label, 0.18, { TextColor3 = currentTheme.TextInactive })
            end
            
            if tab.Icon and typeof(tab.Icon) == "Instance" then
                tween(tab.Icon, 0.18, { ImageColor3 = currentTheme.TextInactive })
            end
        end
        ...
        if selectedTab.Button and typeof(selectedTab.Button) == "Instance" then
            tween(selectedTab.Button, 0.18, { BackgroundColor3 = Color3.fromRGB(0, 122, 255), BackgroundTransparency = 0 })
        ...
        if selectedTab.Label and typeof(selectedTab.Label) == "Instance" then
            tween(selectedTab.Label, 0.18, { TextColor3 = Color3.fromRGB(255, 255, 255) })
        end
        
        if selectedTab.Icon and typeof(selectedTab.Icon) == "Instance" then
            tween(selectedTab.Icon, 0.18, { ImageColor3 = Color3.fromRGB(255, 255, 255) })
        end
    ...
    function self:Tab(name, icon)
        ...
        Button.MouseEnter:Connect(function()
            if self.SelectedTab ~= tabIndex then
                tween(Button, 0.15, { BackgroundColor3 = Color3.fromRGB(60, 60, 65), BackgroundTransparency = 0.5 })
            end
        end)
        
        Button.MouseLeave:Connect(function()
            if self.SelectedTab ~= tabIndex then
                tween(Button, 0.15, { BackgroundColor3 = Color3.fromRGB(0, 0, 0), BackgroundTransparency = 1 })
            end
        end)
