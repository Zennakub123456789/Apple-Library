        ...
        function tab:Input(cfg)
            ...
            local function darkenColor(color, amount)
                return Color3.fromRGB(
                    math.max(0, color.R * 255 - amount),
                    math.max(0, color.G * 255 - amount),
                    math.max(0, color.B * 255 - amount)
                )
            end
            ...
            local holder = create("Frame", {
                ...
                BackgroundColor3 = holderBgColor,
                BorderSizePixel = 0
            })
            create("UICorner", { Parent = holder, CornerRadius = UDim.new(0, 8) })
            create("UIPadding", {
            ...
            inputBox.FocusLost:Connect(function(enterPressed)
                tween(inputBox, 0.2, { BackgroundColor3 = Color3.fromRGB(230, 230, 238) })
                if inputBoxStroke then
                    tween(inputBoxStroke, 0.2, { Color = Color3.fromRGB(190, 190, 200), Thickness = 1.5 })
                end
