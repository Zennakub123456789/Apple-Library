...
function MacUI:Window(config)
    ...
    function self:SelectTab(index)
        ...
        if selectedTab.Label and typeof(selectedTab.Label) == "Instance" then
            print("[DEBUG] Label found:", selectedTab.Label)
            print("[DEBUG] Changing Label color to:", currentTheme.TextActive)
            tween(selectedTab.Label, 0.3, {
                TextColor3 = currentTheme.TextActive
            })
        else
            print("[DEBUG] Label NOT found or not an Instance")
            print("[DEBUG] selectedTab.Label:", selectedTab.Label)
            print("[DEBUG] typeof:", typeof(selectedTab.Label))
        end
